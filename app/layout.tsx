...
import { Inter, Space_Mono, Black_Ops_One, JetBrains_Mono } from 'next/font/google';
import './globals.css';
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.variable} ${spaceMono.variable} ${blockyFont.variable} antialiased bg-[#0a0a0a] text-zinc-300 h-screen overflow-hidden flex font-sans`}>
